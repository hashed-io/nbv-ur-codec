...
describe('encodePSBT', () => {
  test('Valid hex encoded psbt', async () => {
  ...
  test('Invalid psbt', async () => {
    ...
    try {
      ...
      expect(error.message).toContain('Format Error: Invalid Magic Number')
    }
  })
})
